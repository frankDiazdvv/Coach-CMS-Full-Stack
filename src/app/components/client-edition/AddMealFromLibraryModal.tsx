...
interface AddMealModalFromLibraryProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectMeal: (meal: {
    mealName: string;
  ...
  libraryMeal: ISavedMeal;
}

const AddMealFromLibraryModal: React.FC<AddMealModalFromLibraryProps> = ({ isOpen, onClose, onSelectMeal, libraryMeal }) => {
  const [mealName, setMealName] = useState(libraryMeal.mealName);
  const [foods, setFoods] = useState<INutritionFood[]>(libraryMeal.foods);
...
export default AddMealFromLibraryModal;