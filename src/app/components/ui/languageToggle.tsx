...
export default function LanguageToggle() {
    ...
    return(
        <div className="flex items-center space-x-2">
            ...
            >
            <div
                className={`${languageOpen ? "bg-[url(/spain_round.png)] bg-center bg-size-[48px]" : "bg-[url(/us_round.png)] bg-center bg-size-[48px]"} w-7 h-7 rounded-full shadow-md transform transition-all duration-400 ${
